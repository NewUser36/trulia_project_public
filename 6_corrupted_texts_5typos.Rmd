...
df_bbu <- read_feather("embeddings/degraded_texts/5typos/df_bbu_degraded_texts_5typos.feather") %>% as.data.frame()
df_ft <- read_feather("embeddings/degraded_texts/5typos/df_ft_degraded_texts_5typos.feather")
